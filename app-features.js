...
// 1. INIT & STARTUP
// ==========================================
// Note: State management (appState, MASTER_SANTRI, MASTER_KELAS, FILTERED_SANTRI) 
// is defined globally in state.js and accessed via window object
// Note: window.initApp, window.populateClassDropdown, window.handleLogin, 
// window.handleGoogleCallback, window.handleLogout, and window.updateDashboard 
// are defined in app-core.js
...
// Note: window.renderAttendanceList is defined in app-core.js
...
// Note: window.handleSearch, window.changeDateView, window.updateDateDisplay,
// and window.handleDateChange are defined in app-core.js
...
// Note: window.drawDonutChart is defined in app-core.js
